...
This table details various alerts generated by Wazuh.
- The Rule ID, Description, Level, and Count are listed.
- Notable alerts include Apparmor denials, login successes, and failures.
- The highlighted entry shows a successful remote logon detected, with a recommendation to verify KALI is allowed for RDP.
